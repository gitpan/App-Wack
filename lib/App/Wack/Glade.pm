...
<glade-interface>
      ...
      <widget class="GtkVBox" id="vbox1">
          ...
          <widget class="GtkHBox" id="hbox1">
            ...
            <child>
              <widget class="GtkTable" id="table1">
                ...
                <child>
                  <widget class="GtkComboBox" id="after_context">
                    <property name="visible">True</property>
                    <property name="events">GDK_POINTER_MOTION_MASK | GDK_POINTER_MOTION_HINT_MASK | GDK_BUTTON_PRESS_MASK | GDK_BUTTON_RELEASE_MASK</property>
                ...
                <child>
                  <widget class="GtkComboBox" id="before_context">
                    <property name="visible">True</property>
                    <property name="events">GDK_POINTER_MOTION_MASK | GDK_POINTER_MOTION_HINT_MASK | GDK_BUTTON_PRESS_MASK | GDK_BUTTON_RELEASE_MASK</property>
                    <property name="items" translatable="yes"></property>
                    <signal name="changed" handler="on_combo_changed"/>
                ...
                <child>
                  <widget class="GtkCheckButton" id="check-inmemory">
                    <property name="visible">True</property>
                    <property name="can_focus">True</property>
                    <property name="events">GDK_POINTER_MOTION_MASK | GDK_POINTER_MOTION_HINT_MASK | GDK_BUTTON_PRESS_MASK | GDK_BUTTON_RELEASE_MASK</property>
                    <property name="label" translatable="yes">In memory</property>
                    <property name="response_id">0</property>
                    <property name="draw_indicator">True</property>
                    <signal name="toggled" handler="on_check_inmemory_toggled"/>
                  </widget>
                  <packing>
                ...
                <child>
                  <widget class="GtkCheckButton" id="check-all-types">
                    ...
                    <property name="response_id">0</property>
                    <property name="draw_indicator">True</property>
                    <signal name="toggled" handler="on_check_toggled"/>
                  </widget>
                  <packing>
        ...
        <child>
          <widget class="GtkHBox" id="hbox2">
            ...
            <child>
              <widget class="GtkComboBoxEntry" id="search-text">
                <property name="visible">True</property>
                <property name="events">GDK_POINTER_MOTION_MASK | GDK_POINTER_MOTION_HINT_MASK | GDK_BUTTON_PRESS_MASK | GDK_BUTTON_RELEASE_MASK</property>
                ...
                <child internal-child="entry">
                  <widget class="GtkEntry" id="comboboxentry-entry1">
                    ...
                    <property name="can_focus">True</property>
                    <property name="events">GDK_POINTER_MOTION_MASK | GDK_POINTER_MOTION_HINT_MASK | GDK_BUTTON_PRESS_MASK | GDK_BUTTON_RELEASE_MASK</property>
                    <signal name="changed" handler="on_changed_search"/>
                  </widget>
                </child>
              </widget>
              <packing>
  ...
  <widget class="GtkFileChooserDialog" id="directory-selector">
    ...
    <signal name="destroy" handler="on_directory_window_closed"/>
    <signal name="delete_event" handler="on_directory_selector_deleted"/>
          ...
          <widget class="GtkHButtonBox" id="dialog-action_area1">
            ...
            <child>
              <widget class="GtkButton" id="directory-cancel-button">
                ...
                <property name="use_stock">True</property>
                <property name="response_id">0</property>
                <signal name="clicked" handler="on_directory_cancel_clicked"/>
              </widget>
            </child>
            <child>
              <widget class="GtkButton" id="directory-ok-button">
                ...
                <property name="use_stock">True</property>
                <property name="response_id">0</property>
                <signal name="clicked" handler="on_directory_ok_clicked"/>
              </widget>
              <packing>
                <property name="position">1</property>
              </packing>
